...
const bcrypt = require('bcryptjs');//we are going to convert the password into hashed keys for this we are using bcrypt
...
//         }
        ...
        //jwt token has validity so it is more secure
